...
@interface YLMoneyViewController ()<UIWebViewDelegate>

@end

@implementation YLMoneyViewController
...
- (void)viewDidLoad {
    ...
    NSString* path = [[NSBundle mainBundle] pathForResource:@"money" ofType:@"html"];
